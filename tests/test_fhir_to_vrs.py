...
def test_full_allele_translator_returns_expected(fhir_allele_instance, fhir_to, vrs_allele_instance):
    vrs_obj = fhir_to.translate_allele_to_vrs(fhir_allele_instance)
